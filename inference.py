...
# ============================================================
# Mel spectrogram (librosa, no torch dependency)
# ============================================================
def compute_mel(audio, sr=SR):
    """Compute log-mel spectrogram matching torchaudio training pipeline."""
...
def main():
    ...
    # Load ONNX model (input: mel spectrogram, shape (B, 1, n_mels, T))
